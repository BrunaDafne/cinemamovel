...
export default function MovieDetailsHooks({ route, navigation }: Props) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      />
      <RatingBlock rating={rating} onSetStar={setStar} />
      <Overview
...
// -------------------------------------------------------
// 🔹 Blocos separados com memo e contadores individuais
// -------------------------------------------------------
...
const Genres = memo(({ movie }: { movie: any }) => {
  countRender('Genres');
  return (
    <View>
